...
INSERT INTO account (id, name, description, account_type, balance, retired_at, created_by, created_at) VALUES (UUID(), 'Opo wallet', 'Opo wallet', 'asset', 0.0, null, 'system', CURRENT_TIMESTAMP);

INSERT INTO account (id, name, description, account_type, balance, retired_at, created_by, created_at) VALUES (UUID(), 'Books', 'Book and other likewise', 'expense', 0.0, null, 'system', CURRENT_TIMESTAMP);
